...
# david_alan_grier = Node.new("David Alan Grier")
# kyra_sedgwick = Node.new("Kyra Sedgwick")
# dwayne_johnson = Node.new("Dwayne Johnson")
# michelle_rodriguez = Node.new("Michelle Rodriguez")
# casey_hughes = Node.new("Casey Hughes")
